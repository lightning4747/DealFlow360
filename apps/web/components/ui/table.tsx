...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-xl border border-border/70 bg-slate-950/40 backdrop-blur-sm">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn('border-b border-border/80 bg-slate-900/60', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      'border-t border-border/80 bg-slate-900/50 font-medium text-foreground',
      className
    )}
    {...props}
  />
